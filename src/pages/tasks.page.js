...
class TasksPage extends Page {
  ...
  get filterTaskButton ()         { return $('#app > div > div > div:nth-child(3) > div.panel-body > div > form > button.btn.btn-primary.horizontal-gutter'); }
  get exportTasksButton ()        { return $('#app > div > div > div:nth-child(3) > div.panel-body > div > form > button.btn.btn-default.horizontal-gutter.pull-right'); }
